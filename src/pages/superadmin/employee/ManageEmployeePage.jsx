        ...
        <header className="mb-6 sm:mb-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Manage Employees</h1>
              <p className="mt-1 sm:mt-2 text-sm sm:text-base text-slate-600">
                Manage and update employee information across your organization.
              </p>
            </div>
