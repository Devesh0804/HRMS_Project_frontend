      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <header className="mb-6 sm:mb-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Add Admin</h1>
              <p className="mt-1 sm:mt-2 text-sm sm:text-base text-slate-600">
                Create new admin accounts from the super admin workspace using the existing project styling.
              </p>
            </div>
        ...
        <section className="space-y-6 lg:space-y-8">
          <div className="rounded-xl sm:rounded-2xl lg:rounded-3xl bg-white p-4 sm:p-6 shadow-sm">
            <h2 className="text-lg sm:text-xl font-semibold text-slate-900">Admin Onboarding</h2>
            <p className="mt-1 text-sm text-slate-500">
              Capture administrator profile, documents, and banking details from one place.
            </p>
          </div>
          ...
          <EmployeeForm
            ...
            roleName="Admin"
            redirectPath="/superadmin/admin/view"
          />
        </section>
      </div>
    </div>
